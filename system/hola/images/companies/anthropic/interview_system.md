...
Actual questions from recent Anthropic interviews, shared by other Hello Interview users.
...
We have a model that can take batches of up to 100 requests, with any run taking the same amount. Create an interface that allows people to submit items to the model.

Reported by **1** user

Were you asked this too?[View Details](https://www.hellointerview.com/community/questions/cmeds8cre06j0ad08iwsql7ph?company=Anthropic&level=SENIOR)
