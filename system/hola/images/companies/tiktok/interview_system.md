...
Actual questions from recent TikTok interviews, shared by other Hello Interview users.
...
Were you asked this too?[View Details](https://www.hellointerview.com/community/questions/cm6k7xmwh024f11hvvc0uq1e5?company=TikTok&level=MID_LEVEL)
...
Design a video moderation system for a global platform like TikTok, where millions of users post videos every day. The system needs to ensure that all newly posted videos are moderated in near real-time to maintain community standards and safety. Key functional requirements include video ingestion, risk scoring via ML models, rule-based moderation logic, and violation handling. The system should also store the moderation context of each video for audit and reporting purposes.

Reported by **3** users

Were you asked this too?[View Details](https://www.hellointerview.com/community/questions/cm7jsn3bt0082fh44ia25k8tf?company=TikTok&level=SENIOR)
